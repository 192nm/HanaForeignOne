...
import "../../assets/css/Remittance/to-company.css"; 
...
import RecipientForm from './CompanyForm.js';
...
const Tocompany = () => {
  ...
  return (
    <div className="to-company-container">
      <Header />
      <main className={`to-company-main ${animationClass}`}>
        {currentStep === 0 && (
          <>
            <div className="to-company-transfer-section">
              <div className="to-company-input-box">
                <label>You send</label>
                <div className="to-company-input-field">
                  <select>
                  ...
                  />
                  <div className="to-company-flag-box">
                    <img
              ...
              <div className="to-company-input-box">
                ...
                <div className="to-company-input-field">
                  ...
                  <input
                    ...
                    readOnly
                    className="to-company-highlighted"
                  />
                  <div className="to-company-flag-box">
                    <img
            ...
            <div className="to-company-details-section">
              <div className="to-company-details-box">
                <p>적용환율</p>
              ...
              <div className="to-company-details-box to-company-total">
                <p>총 입금액</p>
                <p>{recipientAmount} {currency}</p>
              </div>
            </div>

            <div className="to-company-info-section">
              <p>
            ...
            <button 
              className="to-company-transfer-button"
              onClick={handleNextStep}
            >
              송금하기
            </button>

            <a href="#/" className="to-company-terms-link" onClick={() => setShowModal(true)}>
              송금 신청서류 확인
            </a>
          </>
        )}
      ...
      {showModal && (
        <div className="to-company-modal">
          <div className="to-company-modal-content">
            <span className="to-company-close" onClick={() => setShowModal(false)}>&times;</span>
            <h2>송금 신청서류 안내</h2>
