// RemiUpload.jsx (또는 UploadModal.js)
import {
    Button,
    Box,
    Flex,
  ...
  const UploadModal = ({ onBackClick, onUploadComplete, setModalSize }) => {
    ...
    const onDrop = useCallback((acceptedFiles) => {
      ...
      setOcrResults([]);
      setIsLoading(true);
      // Assuming readBase64 expects a FileList or similar structure
      readBase64({ files: acceptedFiles }, setOcrResults, setIsLoading);
    }, []);
    ...
    const handleRegisterClick = async () => {
      ...
      try {
        ...
        setErrorMessage("서류 등록 중 오류가 발생했습니다. 다시 시도해 주세요.");
        setIsErrorModalOpen(true);
      }
    };
    ...
    const handleModalConfirm = async () => {
      ...
      try {
        ...
        // 부모 컴포넌트로 파일과 OCR 결과 전달
        if (onUploadComplete) {
          onUploadComplete(files[0]); // 파일을 부모 컴포넌트로 전달
        }
      } catch (error) {
        console.error("서류 업데이트 중 오류 발생:", error);
        setErrorMessage("서류 업데이트 중 오류가 발생했습니다. 다시 시도해 주세요.");
        setIsErrorModalOpen(true);
      } finally {
        ...
        >
            ...
            <>
              ...
              <Flex justify="center" mt={6}>
                ...
                <label htmlFor="file-upload">
                  <Button colorScheme="teal" as="span" type="button">
                    파일 선택
                  </Button>
                </label>
              </Flex>
            ...
            <>
              ...
              <Box mt={10} textAlign="center">
                ...
                <Flex justify="center" mt={4} gap={4}>
                  <Button onClick={onBackClick} colorScheme="gray" type="button">
                    닫기
                  </Button>
                  <Button
          ...
          <Modal isOpen={isConfirmOpen} onClose={onConfirmClose} isCentered>
            ...
            <ModalContent>
              ...
              <ModalBody>
                <Text>
                  서류 등록이 완료되었습니다! 첨부 파일을 업데이트하시겠습니까?
                </Text>
              </ModalBody>
  
              <ModalFooter>
                <Button variant="ghost" mr={3} onClick={onConfirmClose} type="button">
                  취소
                </Button>
                <Button
                  colorScheme="teal"
